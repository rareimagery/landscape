 ...
 */
function themeski_install_preprocess_maintenance_page(&$vars) {
  themeski_install_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function themeski_install_preprocess_html(&$vars) {
 ...
 */
function themeski_install_preprocess_page(&$vars) {
 ...
 */
function themeski_install_node_add_list($variables) {
 ...
 */
function themeski_install_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function themeski_install_tablesort_indicator($variables) {
 ...
 */
function themeski_install_css_alter(&$css) {
